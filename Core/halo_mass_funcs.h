...
{
    spline1D logM1_hm_gso1D;
    spline1D logMstar0_hm_gso1D; 
    spline1D beta_hm_gso1D;
    spline1D delta_hm_gso1D;
    spline1D gamma_hm_gso1D;
};
...
struct halo_mass_obj halo_mass_init(void)
{
    ...
    hm_obj.logM1_hm_gso1D = spline1D_create(n, z, logM1);
    hm_obj.logMstar0_hm_gso1D = spline1D_create(n, z, logMstar0);
    hm_obj.beta_hm_gso1D = spline1D_create(n, z, beta);
    hm_obj.delta_hm_gso1D = spline1D_create(n, z, delta);
    hm_obj.gamma_hm_gso1D = spline1D_create(n, z, gamma);
...
double halo_mass__Msol(struct halo_mass_obj hm_obj,
                       double M_star__Msol,
                       double z)
{
    ...
    double delta = spline1D_eval(&hm_obj.delta_hm_gso1D, z);
    double gamma = spline1D_eval(&hm_obj.gamma_hm_gso1D, z);

    double ratio = M_star__Msol / Mstar0;
